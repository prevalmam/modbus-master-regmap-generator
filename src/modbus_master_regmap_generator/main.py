...
def write_modbus_reply_handler_master_c(out_dir: str, entries: list):
    c_lines = [
        ...
        '                incoming = (uint16_t)(((uint16_t)src[0] << 8U) | (uint16_t)src[1]);',
        '                current = *((uint16_t *)dst);',
        '                min = *((uint16_t *)(entry->min_value));',
        '                max = *((uint16_t *)(entry->max_value));',
        ...
        '                incoming = ((uint32_t)src[0] << 24) | ((uint32_t)src[1] << 16) | ((uint32_t)src[2] << 8) | src[3];',
        '                current = *((uint32_t *)dst);',
        '                min = *((uint32_t *)(entry->min_value));',
        '                max = *((uint32_t *)(entry->max_value));',
        '                if ((incoming < min) || (incoming > max)) return -1;',
        ...
        '                incoming = conv.f;',
        '                current = *((float *)dst);',
        '                min = *((float *)(entry->min_value));',
        '                max = *((float *)(entry->max_value));',
        '                if ((incoming < min) || (incoming > max)) return -1;',
